<template>
  <div>
    ...
    <div
      class="fixed-bottom"
      style="padding: 10px 5px; background-color: transparent"
    >
      <mt-button v-if="curStep !== 0" type="default" @click="onStepBtnClick(-1)"
        >上一步</mt-button
      >
      <mt-button
        v-if="curStep !== 4"
...
<script>
import stepsHeaderBar from '../components/stepsHeaderBar.vue'
import agentForm from '../components/agentForm.vue'
import lvPsnForm from '../components/lvPsnForm.vue'
import whereToForm from '../components/whereToForm.vue'
